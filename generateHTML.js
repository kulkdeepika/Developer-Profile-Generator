...
//this function takes in certain values inside the data object and uses these values to generate a html related to a specific person
const generateHTML = function generateHTML(data) {
  return `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8" />
    ...
    <body>
       ...
       <div class="wrapper">
        ...
        //this, so the function can be called from index.js file
module.exports = {
